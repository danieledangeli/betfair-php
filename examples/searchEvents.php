...
$soccerEvents = getAllEventFilteredByEventTypeIds("appkey", "betfairUsr", "betfairPwd");
$searchedEventsWithTextQuery = searchEventsWithTextQuery("appkey", "betfairUsr", "betfairPwd");
$searchedEvents = searchEventsWithTimeRange("appkey", "betfairUsr", "betfairPwd");


function getAllEventFilteredByEventTypeIds($appKey, $username, $pwd)
{
    $eventTypeSoccer = 1;
...
function searchEventsWithTextQuery($appKey, $username, $pwd)
{
...
function searchEventsWithTimeRange($appKey, $username, $pwd)
{
    $betfair = BetfairFactory::createBetfair(
        $appKey,
        $username,
